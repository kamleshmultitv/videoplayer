...
import com.multitv.ott.multitvvideoplayer.previewseekbar.animator.PreviewAnimator;
...
public class PreviewSeekBar extends AppCompatSeekBar implements PreviewBar {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        previewId = typedArray.getResourceId(com.github.rubensousa.previewseekbar.R.styleable.PreviewSeekBar_previewFrameLayout,
                View.NO_ID);

        scrubberColor = typedArray.getColor(com.github.rubensousa.previewseekbar.R.styleable.PreviewSeekBar_previewThumbTint,
                defaultThumbColor);

        setPreviewThumbTint(scrubberColor);

        delegate.setAnimationEnabled(typedArray.getBoolean(
                com.github.rubensousa.previewseekbar.R.styleable.PreviewSeekBar_previewAnimationEnabled, true));
        delegate.setPreviewEnabled(typedArray.getBoolean(
                com.github.rubensousa.previewseekbar.R.styleable.PreviewSeekBar_previewEnabled, true));
        delegate.setAutoHidePreview(typedArray.getBoolean(
                com.github.rubensousa.previewseekbar.R.styleable.PreviewSeekBar_previewAutoHide, true));
        typedArray.recycle();
