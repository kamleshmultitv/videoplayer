...
public class PreviewTimeBar extends DefaultTimeBar implements PreviewBar {
    ...
    public PreviewTimeBar(Context context, AttributeSet attrs) {
        ...
        typedArray = context.getTheme().obtainStyledAttributes(
                attrs, com.github.rubensousa.previewseekbar.exoplayer.R.styleable.PreviewTimeBar, 0, 0);

        previewId = typedArray.getResourceId(
                com.github.rubensousa.previewseekbar.exoplayer.R.styleable.PreviewTimeBar_previewFrameLayout, View.NO_ID);

        delegate = new PreviewDelegate(this);
        delegate.setPreviewEnabled(isEnabled());
        delegate.setAnimationEnabled(typedArray.getBoolean(
                com.github.rubensousa.previewseekbar.exoplayer.R.styleable.PreviewTimeBar_previewAnimationEnabled, true));
        delegate.setPreviewEnabled(typedArray.getBoolean(
                com.github.rubensousa.previewseekbar.exoplayer.R.styleable.PreviewTimeBar_previewEnabled, true));
        delegate.setAutoHidePreview(typedArray.getBoolean(
                com.github.rubensousa.previewseekbar.exoplayer.R.styleable.PreviewTimeBar_previewAutoHide, true));
